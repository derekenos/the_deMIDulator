...
mootLoader
	...
	; enter Flash restore from EEPROM mode if waveform(RC0), record(RC1) & mode(RC2) switches held for 2 second
...
mootLoader_checkReceive
	...
	cpfseq	mlButtonState, ACCESS
	bra		mootLoader_checkRestore
	bra		mootLoader_receiver
mootLoader_checkRestore
	movlw	1<<RC2 ^ 1<<RC1 ^ 1<<RC0
	cpfseq	mlButtonState, ACCESS
	bra		mootLoader_exit
	bra		mootLoader_restore
