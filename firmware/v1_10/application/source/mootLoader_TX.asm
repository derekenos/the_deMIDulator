...
mootLoader_transmitter
	...
	; length = (lastApplicationProgramMemoryAddress - USER_CODE_START_ADDRESS) aligned to 64-byte boundary
	movlw	USER_CODE_START_ADDRESS
	; WREG = low(lastApplicationProgramMemoryAddress) - USER_CODE_START_ADDRESS
	sublw	low(lastApplicationProgramMemoryAddress)
	movwf	mlPayloadLength + 0, ACCESS
	
	movlw	high(lastApplicationProgramMemoryAddress)
	movwf	mlPayloadLength + 1, ACCESS
	; if result of low(lastApplicationProgramMemoryAddress) - USER_CODE_START_ADDRESS <0 then decrement
	btfss	STATUS, C, ACCESS
	decf	mlPayloadLength + 1, f, ACCESS
	
	movlw	upper(lastApplicationProgramMemoryAddress)
...
mootLoader_xmitStartWrite
	call	mootLoader_xmitWriteProgramMemory
...
mootLoader_xmitWriteProgramMemory
	...
	call	mootLoader_xmitSendWpmPacket
	;****************************************
...
mootLoader_xmitWpmByteLp
	...
	; send the packet
	call	mootLoader_xmitSendDataPayloadPacket
	;****************************************
...
mootLoader_xmitWpmSendPayloadComplete
	...
	call	mootLoader_xmitSendDataPayloadCompletePacket
	;****************************************
