...
initSoundGen
	...
	; recall saved modulation from uC's internal EEPROM
	clrf	modulation, ACCESS	

	; recall saved pitchWheel from uC's internal EEPROM
	clrf	pitchWheel + 0, ACCESS	
...
processSoundState
	...
	xorwf	recordOrPlayback, w, ACCESS
	bz		processSoundState_StartADC
	bra		processSoundState_Playback	
...
processSoundState_ADCWait
	...
	; REMEBER that DC-OFFSET will be affected by component tolerances so measure each circuit! No way, you measure each circuit!
