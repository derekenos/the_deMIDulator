...
; ******************* GENERAL MIDI DEFINES ***********************
; ** Define default MIDI channel **
; values 0 - 5 (actual MIDI channels 1 - 6) will make deMIDUlator respond to only that channel
; value of 6 (actual MIDI channel 7) will make deMIDulator respond to ALL channels
	#define		DEFAULT_MIDI_CHANNEL	6
